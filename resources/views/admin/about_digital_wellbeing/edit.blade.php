	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">Digital Wellbeing</h2>
			</div>
		</div>
	</div> 
							...
							<section class="basic_settings">
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										{!! getSinglePlUploadControl('Upload Banner Image (Max 2 MB) (jpg,jpeg) ','wellbeing_banner',['jpg','jpeg'],'image','Select File',null,null,@$postDetails->getData('wellbeing_banner'),$postType) !!}
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										<label>Excerpt</label>
										<textarea id="excerpt" name="meta[text][excerpt]" type="text"  class="form-control ckeditorEn" >{{ $postDetails->getData('excerpt') }}</textarea>
									</div>	
									<div class="col-sm-6 form-group">
