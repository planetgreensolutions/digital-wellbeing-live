                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" name="post[title]" id="post_title" required class="form-control "
                                placeholder="" value="{{ $postDetails->getData('post_title') }}" required />
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" name="post[title_arabic]" id="post_title_arabic" required
                                class="form-control " placeholder=""
                                value="{{ $postDetails->getData('post_title_arabic') }}" required />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <textarea name="meta[text][description]" class="form-control ckeditorEn" id="description"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <?php 
										...
										?>
                            <input type="text" name="post_tags" id="post_tags" class="form-control" placeholder=""
                                value="{{ (old('post_tags'))?old('post_tags'):implode(',',$postTags) }}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            {!! getSinglePlUploadControl('Upload Image (Max 2 MB) (400x400) (jpg,jpeg,png)
                            ','young_people_article_image',['jpg','jpeg','png'],'image','Select
                            File',null,null,@$postDetails->getData('young_people_article_image'),$postType) !!}
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>Upload Page Banner</label>
                            {!! getSinglePlUploadControl(' (1100x500)(Max 2 MB) (jpg,jpeg)
                            ','young_people_banner_inner',['jpg','jpeg'],'image','Select
                            File',null,null,@$postDetails->getData('young_people_banner_inner'),$postType) !!}
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" name="post[priority]" id="post_priority"
                                    class="form-control" placeholder=""
                                    value="{{ $postDetails->getData('post_priority')  }}" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
