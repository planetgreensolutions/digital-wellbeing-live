	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">Add Council Members
				<?php /*
						...
						<section class="basic_settings">
							...
							<div class="row"> 	
								...
								<div class="col-sm-6 form-group">
									...
									<input type="text" name="meta[text][subtitle_arabic]" id="subtitle_arabic" class="form-control" placeholder="" value="{{ old('subtitle_arabic') }}"  />
								</div>	
							</div>
							...
							<div class="col-sm-6 form-group">
								...
								<select class="form-control" id="council_role" name="meta[text][council_role]" required>
									...
									<option value="{{$role->getData('post_id')}}">{{$role->getData('post_title')}}</option>
									@endforeach
								</select>
							</div>
							...
							<div class="row"> 	
								<div class="col-sm-6 form-group">
									...
									{!! getSinglePlUploadControl('Upload Image (Max 2 MB) (jpg,jpeg) 430*474 ','council_image',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['council_image'],$postType) !!}
								</div>
							</div>
						</section>			
