    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
				...
				{{ Form::open(array('url' =>ap('menu_manager/create'),'files'=>true)) }}										
				<div class="card-body">
					 <div class="col-sm-12">
							...
							<section class="">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="mm_title" class="form-control" placeholder="" value="{{Input::old('mm_title')}}"  required /> 
									</div>	
									
									<div class="col-sm-6 form-group">
										<label>Menu Name [Arabic]<em class="red">*</em></label>
										<input type="text" name="mm_title_arabic" class="form-control" placeholder="" value="{{Input::old('mm_title_arabic') }}"  dir="rtl" required /> 
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										<label>Menu Large Name</label>
										<input type="text" name="mm_large_title" class="form-control" placeholder="" value="{{Input::old('mm_large_title')}}"  /> 
									</div>	
									
									<div class="col-sm-6 form-group">
										<label>Menu Large Name [Arabic]</label>
										<input type="text" name="mm_large_title_arabic" class="form-control" placeholder="" value="{{Input::old('mm_large_title_arabic') }}"  dir="rtl"/> 
									</div>
								</div>
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="mm_icon_class" class="form-control" placeholder="" value="{{Input::old('mm_icon_class')}}"  /> 
									</div>	
											...
											<tbody>
												<tr>
												   <td class="text-center">
														{{ Form::checkbox('mm_show_in_main_menu',  1 , true) }}
												   </td>
												   <td>
												...
												<tr>
												   <td class="text-center">
														{{ Form::checkbox('mm_show_in_footer_menu',  1 , true) }}
												   </td>
												   <td>
												...
												<tr>
												   <td class="text-center">
														{{ Form::checkbox('mm_show_in_mobile_menu',  1 , true) }}
												   </td>
												   <td>
												...
												<tr>
												   <td class="text-center">
														{{ Form::checkbox('mm_is_hash_link',  1 , null, ['id'=>'fullHash']) }}
												   </td>
												   <td>
												...
												<tr id="homeHashTR">
												   <td class="text-center">
														{{ Form::checkbox('mm_is_hash_link_in_home_only',  1 ,null,['id'=>'homehash']) }}
												   </td>
												   <td>
												...
												<tr id="mm_top_menu">
												   <td class="text-center">
														{{ Form::checkbox('mm_top_menu',  1 ,null,['id'=>'topmenu']) }}
												   </td>
												   <td>
							...
							<section class="basic_settings">					
								<div class="row"> 
									 <div class="col-sm-6 form-group">
										...
										<input type="number" name="mm_priority" class="form-control" placeholder="" value="{{ (Input::old('mm_priority'))?Input::old('mm_priority'): 1 }}"  min="1" /> 
									</div>	
									<div class="col-sm-6 form-group">
										<label>Status<em class="red">*</em></label>
										<select name="mm_status" class="form-control">
										  <option value="1" {!! (Input::old('mm_status') == '1' ) ? 'selected="selected"' : '' !!}>Activate</option>
										  <option value="2" {!! (Input::old('mm_status') == '2' ) ? 'selected="selected"' : '' !!}>Deactivate</option>
										 </select>
									</div>
								</div>
							</section>
						...
						<div class="form-group">
							 ...
							 <a href="{{  apa('menu_manager') }}" class="btn btn-danger btn-flat">Close</a>
						</div>   
