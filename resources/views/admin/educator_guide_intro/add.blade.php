							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][landingpage_desc]" class="form-control ckeditorEn" id="landingpage_desc" placeholder="" >{{ old('meta')['landingpage_desc'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Landing Page Description [Arabic]</label>
										<textarea name="meta[text][landingpage_desc_arabic]" class="form-control ckeditorAr" id="landingpage_desc_arabic" placeholder="" >{{ old('meta')['landingpage_desc_arabic'] }}</textarea> 
									</div>	
								</div>						
							</section>
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][educatorsintro_intro]" class="form-control ckeditorEn" id="educatorsintro_intro" placeholder="" >{{ old('meta')['educatorsintro_intro'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Educators Introduction [Arabic]</label>
										<textarea name="meta[text][educatorsintro_intro_arabic]" class="form-control ckeditorAr" id="educatorsintro_intro_arabic" placeholder="" >{{ old('meta')['educatorsintro_intro_arabic'] }}</textarea> 
									</div>	
								</div>						
							</section>
					</div>
