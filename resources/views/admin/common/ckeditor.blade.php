...
var CKconfig = {
		...
		filebrowserBrowseUrl: '{{ asset(Config::get("app.admin_prefix")."/file_browser_ckeditor") }}?type=file',
		filebrowserUploadUrl: '{{ asset(Config::get("app.admin_prefix")."/file_upload_ckeditor") }}?type=file',
		filebrowserImageBrowseUrl: '{{ asset(Config::get("app.admin_prefix")."/file_browser_ckeditor") }}?type=image',
		filebrowserImageUploadUrl: '{{ asset(Config::get("app.admin_prefix")."/file_upload_ckeditor") }}?type=image',
		/**/
