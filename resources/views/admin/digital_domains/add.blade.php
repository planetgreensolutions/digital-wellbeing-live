...
<div class="container-fluid dashboard-content">
	...
	{{ Form::open(array('url' => array(apa('post/digital_domains/add')),'files'=>true,'id'=>'add-form')) }}
							...
							<section class="basic_settings">
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										{!! getSinglePlUploadControl(' (500x500)(Max 2 MB) (jpg,jpeg) ','digital_domain_banner',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['digital_domain_banner'],$postType,1487,923) !!}
									</div>
									<div class="col-sm-6 form-group">
										<label>Upload Page Banner</label>
										{!! getSinglePlUploadControl(' (1100x500)(Max 2 MB) (jpg,jpeg) ','digital_domain_banner_inner',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['digital_domain_banner_inner'],$postType) !!}
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="meta[text][sub_title]" id="sub_title" class="form-control" placeholder="" value="{{ old('meta')['sub_title'] }}"  />
									</div>	
									<div class="col-sm-6 form-group">
										<label>Sub Title [Arabic]</label>
										<input type="text" name="meta[text][sub_title_arabic]" id="sub_title_arabic" dir="rtl" class="form-control" placeholder="" value="{{ old('meta')['sub_title_arabic'] }}"  />
									</div>	
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
							...
							<section class="basic_settings">
								...
								<div class="row">
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][learnit]" class="form-control ckeditorEn" id="learnIt" placeholder="" >{{ old('meta')['learnit'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Learn It [Arabic]</label>
										<textarea name="meta[text][learnit_arabic]" class="form-control ckeditorAr" id="learnItAr" placeholder="" >{{ old('meta')['learnit_arabic'] }}</textarea> 
									</div>	
								</div>			
							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][preventit]" class="form-control ckeditorEn" id="preventit" placeholder="" >{{ old('meta')['preventit'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Prevent It [Arabic]</label>
										<textarea name="meta[text][preventit_arabic]" class="form-control ckeditorAr" id="preventitAr" placeholder="" >{{ old('meta')['preventit_arabic'] }}</textarea> 
									</div>	
								</div>						
							</section>	
							<hr/>
							<section class="basic_settings">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][actonit]" class="form-control ckeditorEn" id="actonit" placeholder="" >{{ old('meta')['actonit'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Act On It [Arabic]</label>
										<textarea name="meta[text][actonit_arabic]" class="form-control ckeditorAr" id="actonitAr" placeholder="" >{{ old('meta')['actonit_arabic'] }}</textarea> 
									</div>	
								</div>						
							</section>	
							<hr/>
