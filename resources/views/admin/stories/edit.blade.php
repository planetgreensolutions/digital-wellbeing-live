	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">New Stories
				<?php /*
				...
				<div class="card">
					...
					<?php /* <section class="basic_settings">
							...
							<section class="basic_settings">
								<div class="row"> 	
									<div class="col-sm-6 form-group">
									{!! getSinglePlUploadControl('Upload Image 500x500 (Max 2 MB) (jpg,jpeg) ','stories_image',['jpg','jpeg'],'image','Select File',null,null,@$postDetails->getData('stories_image'),$postType) !!}
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										<label>Excerpt</label>
										<textarea id="excerpt" name="meta[text][excerpt]" type="text"  class="form-control" >{{ $postDetails->getData('excerpt') }}</textarea>
									</div>	
									<div class="col-sm-6 form-group">
										<label>Excerpt [Arabic]</label>
										<textarea id="excerpt_arabic" name="meta[text][excerpt_arabic]" type="text"  dir="rtl" class="form-control" >{{ $postDetails->getData('excerpt_arabic') }}</textarea>
									</div>	
								</div>
							</section>	
							<section class="basic_settings">
