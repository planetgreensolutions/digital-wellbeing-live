							...
							<section class="basic_settings">
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										{!! getSinglePlUploadControl(' (Max 2 MB) (jpg,jpeg) 500*500 ','stories_image',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['stories_image'],$postType) !!}
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<textarea id="excerpt_arabic" name="meta[text][excerpt_arabic]" type="text"  dir="rtl" class="form-control" >{{ old('meta')['excerpt_arabic'] }}</textarea>
									</div>	
								</div>
							</section>	
							<section class="basic_settings">
