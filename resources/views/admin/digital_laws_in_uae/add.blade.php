	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">Digital Laws in UAE</h2>
			</div>
		</div>
	</div> 
							...
							<section class="basic_settings">
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										{!! getSinglePlUploadControl('Upload Banner (Max 2 MB) (jpg,jpeg) ','aboutus_banner',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['aboutus_banner'],$postType,1487,923) !!}
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][description]" class="form-control ckeditorEn" id="description" placeholder="" >{{ old('meta')['aboutus_desc'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Large Description [Arabic]</label>
										<textarea name="meta[text][description_arabic]" class="form-control ckeditorAr" id="description_arabic" placeholder="" >{{ old('meta')['aboutus_desc_arabic'] }}</textarea> 
									</div>	
								</div>						
							</section>
					</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="hidden" name="post[priority]" id="post_priority"  class="form-control" placeholder="" value="1"  />
