						...
						<section class="basic_settings">
							...
							<div class="row"> 	
								<div class="col-sm-6 form-group">
									...
									<textarea name="meta[text][top_description]" class="form-control ckeditorEn" id="top_description" placeholder="" >{{ $postDetails->getData('top_description') }}</textarea> 
								</div>
								<div class="col-sm-6 form-group">
									<label>Top Description [Arabic]</label>
									<textarea name="meta[text][top_description_arabic]" class="form-control ckeditorAr" id="top_description_arabic" placeholder="" >{{ $postDetails->getData('top_description_arabic') }}</textarea> 
								</div>
							</div>
							...
							<div class="row"> 	
								<div class="col-sm-6 form-group">
									...
									<textarea name="meta[text][bottom_description]" class="form-control ckeditorEn" id="bottom_description" placeholder="" >{{ $postDetails->getData('bottom_description') }}</textarea> 
								</div>
								<div class="col-sm-6 form-group">
									<label>Bottom Description [Arabic]</label>
									<textarea name="meta[text][bottom_description_arabic]" class="form-control ckeditorAr" id="bottom_description_arabic" placeholder="" >{{ $postDetails->getData('bottom_description_arabic') }}</textarea> 
								</div>
							</div>
						</section>
