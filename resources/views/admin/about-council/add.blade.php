	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">About Council
				<?php /*
						...
						<section class="basic_settings">
							<div class="row"> 	
								...
								<div class="col-sm-6 form-group">
									...
									<input type="text" name="post[title_arabic]" id="post_title_arabic" class="form-control" placeholder="" value="{{ old('post_title_arabic') }}"  />
								</div>	
							</div>
							...
							<div class="row"> 	
								<div class="col-sm-6 form-group">
									...
									<textarea name="meta[text][top_description]" class="form-control ckeditorEn" id="top_description" placeholder="" >{{ old('meta')['top_description'] }}</textarea> 
								</div>
								<div class="col-sm-6 form-group">
									<label>Top Description [Arabic]</label>
									<textarea name="meta[text][top_description_arabic]" class="form-control ckeditorAr" id="top_description_arabic" placeholder="" >{{ old('meta')['top_description_arabic'] }}</textarea> 
								</div>
							</div>
							...
							<div class="row"> 	
								<div class="col-sm-6 form-group">
									...
									<textarea name="meta[text][bottom_description]" class="form-control ckeditorEn" id="bottom_description" placeholder="" >{{ old('meta')['bottom_description'] }}</textarea> 
								</div>
								<div class="col-sm-6 form-group">
									<label>Bottom Description [Arabic]</label>
									<textarea name="meta[text][bottom_description_arabic]" class="form-control ckeditorAr" id="bottom_description_arabic" placeholder="" >{{ old('meta')['bottom_description_arabic'] }}</textarea> 
								</div>
							</div>
