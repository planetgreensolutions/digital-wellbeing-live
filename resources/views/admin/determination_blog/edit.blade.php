			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="card">
					<div class="card-body">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										{!! getSinglePlUploadControl('Upload Image (Max 2 MB) (400x400) (jpg,jpeg,png) ','determination_blog_image',['jpg','jpeg','png'],'image','Select File',null,null,@$postDetails->getData('determination_blog_image'),$postType) !!}
									</div>
								</div>	
