							...
							<section class="basic_settings">
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										{!! getSinglePlUploadControl('Upload Banner Image (Max 2 MB) (jpg,jpeg) ','digital_citizenship_banner',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['digital_citizenship_banner'],$postType,1487,923) !!}
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
