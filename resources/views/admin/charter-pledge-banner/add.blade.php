						...
						<section class="basic_settings">
							...
							<div class="row">
								<div class="col-sm-6 form-group">
									...
									<textarea id="html_title" name="meta[largetext][html_title]" type="text"  class="form-control ckeditorEn" >{{ old('meta')['html_title'] }}</textarea>
								</div>
								<div class="col-sm-6 form-group">
									<label>HTML Title [Arabic]</label>
									<textarea id="html_title_arabic" name="meta[largetext][html_title_arabic]" type="text"  dir="rtl" class="form-control ckeditorAr" >{{ old('meta')['html_title_arabic'] }}</textarea>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6 form-group">
									<label>Description</label>
									<textarea id="description" name="meta[largetext][description]" type="text"  class="form-control ckeditorEn" >{{ old('meta')['description'] }}</textarea>
								</div>
								<div class="col-sm-6 form-group">
									<label>Description [Arabic]</label>
									<textarea id="description_arabic" name="meta[largetext][description_arabic]" type="text"  dir="rtl" class="form-control ckeditorAr" >{{ old('meta')['description_arabic'] }}</textarea>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6 form-group">
									<label>Pop up Message</label>
									<textarea id="popup_msg" name="meta[largetext][popup_msg]" type="text"  class="form-control ckeditorEn" >{{ old('meta')['popup_msg'] }}</textarea>
								</div>
								<div class="col-sm-6 form-group">
									<label>Pop up Message [Arabic]</label>
									<textarea id="popup_msg_arabic" name="meta[largetext][popup_msg_arabic]" type="text"  dir="rtl" class="form-control ckeditorAr" >{{ old('meta')['popup_msg_arabic'] }}</textarea>
								</div>
							</div>
						</section>
					</div>
