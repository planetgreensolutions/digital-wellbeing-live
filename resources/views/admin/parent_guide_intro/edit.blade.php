	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">Parents Section Introduction</h2>
			</div>
		</div>
	</div> 
				...
				<div class="card">
					<div class="card-body">
							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										{!! getSinglePlUploadControl('Upload Banner Image (Max 2 MB) (jpg,jpeg) 700x700','pg_banner_image',['jpg','jpeg'],'image','Select File',null,null,@$postDetails->getData('pg_banner_image'),$postType) !!}
									</div>
								</div>
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="meta[text][pg_home_title]" class="form-control " id="pg_home_title" placeholder="" value="{{ $postDetails->getData('pg_home_title') }}" />
									</div>
									<div class="col-sm-6 form-group">
										<label>Home Title [Arabic]</label>
										<input type="text" name="meta[text][pg_home_title_arabic]" class="form-control " dir="rtl" id="pg_home_title_arabic" placeholder=""  value="{{ $postDetails->getData('pg_home_title_arabic') }}" />
									</div>	
								</div>						
							</section>	
							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										<label>Parents Introduction</label>
										<textarea name="meta[text][parentsintro_desc]" class="form-control ckeditorEn" id="parentsintro_desc" placeholder="" >{{ $postDetails->getData('parentsintro_desc') }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Parents Introduction [Arabic]</label>
										<textarea name="meta[text][parentsintro_desc_arabic]" class="form-control ckeditorAr" id="parentsintro_desc_arabic" placeholder="" >{{ $postDetails->getData('parentsintro_desc_arabic') }}</textarea> 
									</div>	
								</div>						
							</section>
