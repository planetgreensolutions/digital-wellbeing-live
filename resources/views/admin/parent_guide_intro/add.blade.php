							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][parentsintro_desc]" class="form-control ckeditorEn" id="learnIt" placeholder="" >{{ old('meta')['parentsintro_desc'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Large Description [Arabic]</label>
										<textarea name="meta[text][parentsintro_desc_arabic]" class="form-control ckeditorAr" id="learnItAr" placeholder="" >{{ old('meta')['parentsintro_desc_arabic'] }}</textarea> 
									</div>	
								</div>						
							</section>
					</div>
