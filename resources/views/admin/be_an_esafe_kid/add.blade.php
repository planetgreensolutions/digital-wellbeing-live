                    ...
                    <section class="basic_settings">
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                {!! getSinglePlUploadControl('Upload Image 425x285 (Max 2 MB) (jpg,jpeg,png) ', 'be_an_esafe_kid_image', ['jpg', 'jpeg', 'png'], 'image', 'Select File', null, null, @Input::old('meta')['text']['be_an_esafe_kid_image'], $postType) !!}
                            </div>
                        </div>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" name="meta[text][youtube_link]" id="website_link" class="form-control" placeholder="" value="{{ old('meta')['text']['website_link'] }}"  required/>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Youtube Link (Arabic)</label>
                                    <input type="text" name="meta[text][youtube_link_arabic]" id="youtube_link_arabic" class="form-control" placeholder="" value="{{ old('meta')['text']['youtube_link_arabic'] }}"  required/>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <label>Upload Image</label>
                                {!! getSinglePlUploadControl('Youtube Image 1330x800 (Max 2 MB) (jpg,jpeg,png) ', 'youtube_image', ['jpg', 'jpeg', 'png'], 'image', 'Select File', null, null, @Input::old('meta')['text']['youtube_image'], $postType) !!}
                            </div>
                        </div>
