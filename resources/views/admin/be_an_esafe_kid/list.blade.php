...
<div class="container-fluid dashboard-content">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Manage Categories
                    @if ($buttons['add'])
    ...
    <div>
        {{ Form::open(['name' => 'filter-reg', 'url' => route('post_index', [$postType]), 'method' => 'get']) }}
        <div class="row">
            <div class="col-sm-4 form-group">
                <input type="text" name="post_title"
                    class="form-control border {{ !empty(Input::get('post_title')) ? 'border-green' : '' }}"
                    value="{{ Input::get('post_title') }}" placeholder="Filter by Title" />
            </div>
            <div class="col-sm-4 form-group">
                <input type="submit" class=" btn btn-success" />
                <a href="{{ asset(Config::get('app.admin_prefix') . '/post/be_an_esafe_kid') }}"><input type="button"
                        name="filterNow" class=" btn btn-primary" value="Reset" /></a>
            </div>
        </div>
            ...
            <div class="card">
                <div class="col-sm-12 card-header my-table-header">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h5 class="">{{ $post_items->total() }} results found.</h5>
                        </div>
