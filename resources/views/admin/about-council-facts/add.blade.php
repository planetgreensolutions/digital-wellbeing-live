	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">Add About Council - Facts
				<?php /*
						...
						<section class="basic_settings">
							...
							<div class="row"> 	
								<div class="col-sm-6 form-group">
									...
									{!! getSinglePlUploadControl('Upload Image (Max 2 MB) (jpg,jpeg,png)','ac_facts_image',['jpg','jpeg', 'png'],'image','Select File',null,null,@Input::old('meta')['text']['ac_facts_image'],$postType) !!}
								</div>
							</div>
						</section>			
