							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<select class="form-control" id="guide_lang" name="meta[text][guide_lang]">
											<option <?php echo (  old('guide_lang')  == 1 )?'selected =="selected"':""; ?> value="en">English</option>
											<option <?php echo ( old('guide_lang') == 2 )?'selected =="selected"':''; ?> value="ar">Arabic</option>
										</select>
									</div>	
								</div>	 
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										{!! getSinglePlUploadControl('Upload Banner Image (Max 2 MB) (jpg,jpeg) 500*500 ','guides_tips_banner',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['guides_tips_banner'],$postType) !!}
									</div>
								</div>
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<input type="hidden" name="post[title_arabic]" id="post_title_arabic"  value="{{ old('post_title') }}"  />
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										<label>Excerpt</label>
										<textarea id="excerpt" name="meta[text][excerpt]" type="text"  class="form-control" >{{ old('meta')['excerpt'] }}</textarea>
									</div>	
