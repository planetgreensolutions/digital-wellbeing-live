		...
		<section class="wiz-content">
			...
			<div class="block_">
				...
				<div class="row">
					...
					@include('frontend.form_view_partials.textbox',['fieldName'=>'govt_agency','fieldLabel'=>lang('govt_agency_name'),'step'=>1, 'required'=>true,'autoFocus'=>true])
		...
		<section class="wiz-content">
			<div class="block_">
				<h3 class="sub-title text-colo-brand " data-number="04">
				  <span>{{ lang('about_govt_develop_since_estab') }} <span>(200 كلمة)</span></span>
				</h3>
				<div class="row">
			...
			<div class="block_">
				<h3 class="sub-title text-colo-brand " data-number="05">
				  <span>{{ lang('govt_agency_main_task') }} <span>(100 كلمة)</span></span>
				</h3>
				<div class="row">
			...
			<div class="block_">
				<h3 class="sub-title text-colo-brand " data-number="06">
				  <span>{{ lang('important_govt_services') }} <span>(100 كلمة)</span></span>
				</h3>
				<div class="row">
			...
			<div class="block_">
				<h3 class="sub-title text-colo-brand " data-number="07">
				  <span>{{ lang('govt_partner_dealer') }} <span>(100 كلمة)</span></span>
				</h3>
				<div class="row">
