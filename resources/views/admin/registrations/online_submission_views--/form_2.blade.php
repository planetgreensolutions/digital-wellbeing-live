	<div id="form2_wrapper">
		...
		<section class="wiz-content">
			...
			<div class="block_">
				...
				<div class="row">
					...
					@include('frontend.form_view_partials.textbox',['fieldName'=>'name_of_govt_authority','fieldLabel'=>lang('name_of_govt_authority'),'step'=>1, 'required'=>true,'autoFocus'=>true])
		...
		<section class="wiz-content">
			<div class="block_">
				...
				<h3 class="sub-title text-colo-brand " >
				  <span>{{ lang('project_idea') }} <span>({{ trans('messages.x_words',['count'=>200]) }})</span></span>
				</h3>
				<div class="row">
		...
		<section class="wiz-content">
			<div class="block_">
				...
				<h3 class="sub-title text-colo-brand ">
				  <span>{{ lang('project_planning') }} <span>({{ trans('messages.x_words',['count'=>200]) }})</span></span>
				</h3>
				<div class="row">
		...
		<section class="wiz-content">
			<div class="block_">
				...
				<h3 class="sub-title text-colo-brand " >
				  <span>{{ lang('project_effectiveness') }} <span>({{ trans('messages.x_words',['count'=>200]) }})</span></span>
				</h3>
		...
		<section class="wiz-content">
			<div class="block_">
				...
				<h3 class="sub-title text-colo-brand " >
				  <span>{{ lang('project_outcomes') }} <span>({{ trans('messages.x_words',['count'=>200]) }})</span></span>
				</h3>
				<div class="row">				
