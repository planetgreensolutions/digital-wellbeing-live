<div id="form5_wrapper">
	...
	<section class="wiz-content">
		...
		<div class="block_">
			<h3 class="sub-title text-colo-brand " data-number="01">
				<span>{{ lang('candidacy_application') }}</span>
			</h3>
			<div class="row">
				...
				@include('frontend.form_view_partials.textbox',['fieldName'=>'entity_namee','fieldLabel'=>lang('entity_namee'),'step'=>1, 'required'=>true,'autoFocus'=>false])
				
				
			</div>
			<h3 class="sub-title text-colo-brand " data-number="02">
				<span>{{ lang('candidate_personal_info') }}</span>
			</h3>
			<div class="row">
					@include('frontend.form_view_partials.offline_image',['fieldName'=>'personal_photo','fieldLabel'=>lang('personal_photo'),'step'=>1,'required'=>true,'subQuestion'=> null,'helpText'=>null])						
	...
	<section class="wiz-content">
		<div class="block_">
			...
			<h3 class="sub-title text-colo-brand ">
				<span>{{ lang('peformance_achievement_job') }}</span>
			</h3>
			<div class="row">
	...
	<section class="wiz-content">
		<div class="block_">
			...
			<h3 class="sub-title text-colo-brand ">
				<span>{{ lang('impact_work_society') }}</span>
			</h3>
			<div class="row">
	...
	<section class="wiz-content">
		<div class="block_">
			...
			<h3 class="sub-title text-colo-brand ">
				<span>{{ lang('initiative_and_innovation') }}</span>
			</h3>
			<div class="row">
	...
	<section class="wiz-content">
		<div class="block_">
			...
			<h3 class="sub-title text-colo-brand ">
				<span>{{ lang('role_positive_model') }} </span>
			</h3>
			<div class="row">
	...
	<section class="wiz-content">
		<div class="block_">
			...
			<h3 class="sub-title text-colo-brand ">
				<span>{{ lang('continous_learning') }} </span>
			</h3>
			<div class="row">
