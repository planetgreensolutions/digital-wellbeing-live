		...
		<section class="wiz-content">
			...
			<div class="block_">
				<h3 class="sub-title text-colo-brand " data-number="01">
				  <span>{{ lang('entity_information') }}</span>
				</h3>
				<div class="row">
					...
					@include('frontend.form_view_partials.textbox',['fieldName'=>'entity_namee','fieldLabel'=>lang('smartapp_agency'),'step'=>1, 'required'=>true,'autoFocus'=>false])
				...
				<div class="row">
					...
					<?php /*@include('frontend.form_view_partials.textbox',['fieldName'=>'smartapp_agency','fieldLabel'=>lang('smartapp_agency'),'step'=>1, 'required'=>true,'autoFocus'=>true]) */ ?>
			...
			<div class="block_">
				<h3 class="sub-title text-colo-brand " data-number="04">
				  <span>{{ lang('smart_social_networks') }}</span>
				</h3>	
