							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										...
										<textarea name="meta[text][description]" class="form-control ckeditorEn" id="learnIt" placeholder="" >{{ old('meta')['description'] }}</textarea> 
									</div>
									<div class="col-sm-6 form-group">
										<label>Large Description [Arabic]</label>
										<textarea name="meta[text][description_arabic]" class="form-control ckeditorAr" id="learnItAr" placeholder="" >{{ old('meta')['description_arabic'] }}</textarea> 
									</div>	
								</div>						
							</section>
					</div>
