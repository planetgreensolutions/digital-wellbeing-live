	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">Create Sannif Online
							...
							<section class="basic_settings">
								<div class="row">
									<div class="col-sm-6 form-group">
										...
										{!! getSinglePlUploadControl('Upload Banner Image (Max 2 MB) (jpg,jpeg) ','sannif_online_image',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['sannif_online_image'],$postType,1487,923) !!}
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6 form-group">
