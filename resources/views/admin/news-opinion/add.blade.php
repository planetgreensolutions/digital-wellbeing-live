					...
					<div class="card-body">
							...
							<?php /*	<div class="col-sm-6 form-group">
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										<label>Excerpt</label>
										<textarea id="excerpt" name="meta[text][excerpt]" type="text"  class="form-control " >{{ old('meta')['text']['excerpt'] }}</textarea>
									</div>

									<div class="col-sm-6 form-group">
										<label>Excerpt[Arabic]</label>
										<textarea id="excerpt_arabic" name="meta[text][excerpt_arabic]" type="text"  class="form-control " >{{ old('meta')['text']['excerpt_arabic'] }}</textarea>
									</div>										
