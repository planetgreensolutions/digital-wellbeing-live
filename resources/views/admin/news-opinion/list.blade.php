        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Manage News And Opinions
						@if($buttons['add'] )
                                ...
                                <tbody>
                                    @if( !empty($post_items) && $post_items->count() >0 )
										...
										?>
                                            <tr>
                                                <th scope="row">{{ $inc++ }}</th>
                                                <td><?php if($item->getData('post_title_arabic')=="NA"){
															echo $item->getData('post_title');
														   }else{ 
															echo $item->getData('post_title_arabic'); } 
													?></td>
                                                <td>@if($item->getData('post_title')!="NA" && $item->getData('post_title_arabic')!="NA") Both @elseif($item->getData('post_title')=="NA") العربية @else English @endif</td>
