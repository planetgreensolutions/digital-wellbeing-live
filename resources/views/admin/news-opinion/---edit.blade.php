							...
							<div class="row"> 	
							   <div class="col-sm-6 form-group">
								...
								<select class="form-control" id="news_lang" name="meta[text][news_lang]">
									<option <?php echo ($postDetails->getData('news_lang') == 'en' )?'selected =="selected"':""; ?> value="en">English</option>
									<option <?php echo ( $postDetails->getData('news_lang') == 'ar' )?'selected =="selected"':''; ?> value="ar">Arabic</option>
								</select>
								...
								<div class="row"> 	
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="post[title]" id="post_title" required class="form-control language" placeholder="" value="{{ $postDetails->getData('post_title') }}"  required/>
										<input type="hidden" name="post[title_arabic]" id="title_arabic" class="form-control " value="{{ $postDetails->getData('post_title') }}"  />
									</div>	
									<div class="col-sm-6 form-group">
								...
								<div class="row"> 	
									<div class="col-sm-12 form-group">
										...
										<input type="text" name="meta[text][subtitle]" id="subtitle" class="form-control language" placeholder="" value="{{ $postDetails->getData('subtitle') }}"  />
									</div>	
							...
							<section class="basic_settings">
								...
								<div class="row"> 	
									...
									<div class="col-sm-12 form-group">
										...
										<textarea name="meta[text][description]" class="form-control language ckeditorEn" id="description" placeholder="" >{{ $postDetails->getData('description') }}</textarea> 
									</div>
