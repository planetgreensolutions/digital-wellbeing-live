                ...
                <div class="card-body">
                    <section class="basic_settings">
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                {!! getSinglePlUploadControl(' (Max 2 MB) (jpg,jpeg,png) 425x285 ', 'i_want_help_with_image', ['jpg', 'jpeg', 'png'], 'image', 'Select File', null, null, @Input::old('meta')['text']['i_want_help_with_image'], $postType) !!}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 form-group">
                    ...
                    <section class="basic_settings">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="meta[text][help_with_desc_heading]" id="help_with_desc_heading"
                                    ...
                                    value="{{ old('meta')['help_with_desc_heading'] }}" />
                            </div>
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="meta[text][help_with_desc_heading_arabic]"
                                    ...
                                    value="{{ old('meta')['help_with_desc_heading_arabic'] }}" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <textarea name="meta[text][description]" class="form-control  ckeditorEn"
                                    id="description"
                                    placeholder="">{{ old('meta')['text']['description'] }}</textarea>
                            </div>

                            <div class="col-sm-6 form-group">
                                <label>Description[Arabic]</label>
                                <textarea name="meta[text][description_arabic]" class="form-control  ckeditorEn"
                                    id="description_arabic" dir="rtl"
                                    placeholder="">{{ old('meta')['text']['description_arabic'] }}</textarea>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <label>Upload Image</label>
                                {!! getSinglePlUploadControl(' (Max 2 MB) (jpg,jpeg,png) 694x712 ', 'help_with_desc_image', ['jpg', 'jpeg', 'png'], 'image', 'Select File', null, null, @Input::old('meta')['text']['help_with_desc_image'], $postType) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="meta[text][help_with_step_heading]" id="help_with_step_heading"
                                    class="form-control" placeholder=""
                                    value="{{ old('meta')['help_with_step_heading'] }}" />
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Heading [Arabic]</label>
                                <input type="text" name="meta[text][help_with_step_heading_arabic]"
                                    ...
                                    value="{{ old('meta')['help_with_step_heading_arabic'] }}" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="meta[text][help_with_step1]" id="help_with_step1"
                                    class="form-control" placeholder=""
                                    value="{{ old('meta')['help_with_step1'] }}" />
                            </div>
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="meta[text][help_with_step1_arabic]" id="help_with_step1_arabic"
                                    ...
                                    value="{{ old('meta')['help_with_step1_arabic'] }}" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="meta[text][help_with_step10]" id="help_with_step1"
                                    class="form-control" placeholder=""
                                    value="{{ old('meta')['help_with_step10'] }}" />
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Step10 [Arabic]</label>
                                <input type="text" name="meta[text][help_with_step10_arabic]"
                                    id="help_with_step10_arabic" dir="rtl" class="form-control" placeholder=""
                                    value="{{ old('meta')['help_with_step10_arabic'] }}" />
                            </div>
                        </div>
