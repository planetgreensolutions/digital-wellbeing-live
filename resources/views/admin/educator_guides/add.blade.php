	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="page-header">
				<h2 class="pageheader-title">New Educator Guides
				<?php /*
				...
				<div class="card">
					<div class="card-body">
							...
							<section class="basic_settings">
								<div class="row"> 	
									...
									<div class="col-sm-6 form-group">
										{!! getSinglePlUploadControl('Upload Banner Image (Max 2 MB) (jpg,jpeg) ','parentguide_banner',['jpg','jpeg'],'image','Select File',null,null,@Input::old('meta')['text']['parentguide_banner'],$postType) !!}
									</div>
								</div>
							</section>
							<section class="basic_settings">
							...
							<section class="basic_settings">
								...
								<?php /*	 <section class="basic_settings custom_section_block">
								<hr/>
								<div class="row"> 
									<div class="col-sm-12">											
										<label>Tags</label>
