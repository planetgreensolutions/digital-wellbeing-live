      ...
      <div class="container">
		<div class="breadCrumbWrap ">
			<ol class="breadcrumb">
				...
				<li class="current">{{$sannif_online->getData('post_title') }}</li>
			</ol>
		</div>
        ...
        <div class="side_box">
          ...
          <div class="inner_box">
            <div class="link_">
              ...
              <div class="img_box">
                <div class="img_ b-lazy" data-src="{{ PP($sannif_online->getData('sannif_online_image'))}}"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="content_box">
          ...
          <h1 class="section-title txt-up" >
              <div class="title_wr">
                <span>{{$sannif_online->getData('post_title') }}</span>
              </div>
          </h1>
          {{-- <h2 class="section-sub-title"><span>{{$sannif_online->getData('sub_title') }}</span></h2> --}}
        </div>
          <div class="text_box">
            {!!$sannif_online->getData('description') !!}
