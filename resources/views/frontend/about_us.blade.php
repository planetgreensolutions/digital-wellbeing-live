      ...
      <div class="container">
		<div class="breadCrumbWrap ">
			<ol class="breadcrumb">
				...
				<li class="current">{{$about_details->getData('post_title') }}</li>
			</ol>
		</div>
        ...
        <div class="side_box">
          ...
          <div class="inner_box">
            <div class="link_">
              ...
              <div class="img_box">
                <div class="img_ b-lazy" data-src="{{ PP($about_details->getData('aboutus_banner'))}}"></div>                
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="content_box">
          ...
          <h1 class="section-title txt-up" >
              <div class="title_wr">
                <span>{{$about_details->getData('post_title') }}</span>
              </div>
          </h1>
        </div>
          <div class="text_box">
            {!!$about_details->getData('description') !!}
