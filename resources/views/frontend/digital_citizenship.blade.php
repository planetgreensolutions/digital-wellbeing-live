      ...
      <div class="container">
		<div class="breadCrumbWrap ">
			<ol class="breadcrumb">
				...
				<li class="current">{{$digital_citizenship->getData('post_title') }}</li>
			</ol>
		</div>
        ...
        <div class="side_box">
          ...
          <div class="inner_box">
            <div class="link_">
              ...
              <div class="img_box">
                <div class="img_ b-lazy" data-src="{{ PP($digital_citizenship->getData('digital_citizenship_banner'))}}"></div>                
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="content_box">
          ...
          <h1 class="section-title txt-up" >
              <div class="title_wr">
                <span>{{$digital_citizenship->getData('post_title') }}</span>
              </div>
          </h1>
          <h2 class="section-sub-title"><span>{{$digital_citizenship->getData('sub_title') }}</span></h2>
        </div>
          <div class="text_box">
            {!!$digital_citizenship->getData('description') !!}
