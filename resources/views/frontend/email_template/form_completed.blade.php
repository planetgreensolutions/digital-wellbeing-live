															...
															<p  style="text-align: right;">
																<span style="font-family:tahoma,verdana,segoe,sans-serif">
																	<span style="font-size:17px;"> 																					
																		...
																		<p style="text-align: right;direction: rtl;">{{ lang('to_view_the_application') }} <a style="font-weight:800" href="{{ asset('ar/view-online-submission/'.$formDetails->fm_category_slug.'/'.$formDetails->fm_form_slug) }}">{{ lang('please_click_on_the_link') }}</a></p>
