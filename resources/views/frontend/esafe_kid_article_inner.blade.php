...
<?php
    $item = $articleDetails->geteSafeCategory();
    $videoUrl = $item->getData('youtube_link');

    if($videoUrl)
    {
        if($item->getData('youtube_image'))
        {
            $ytImage = PP($item->getData('youtube_image'));
        }
        else
        {
    ...
    <div class="stage video_ ">
    <a href="{{ $videoUrl }}" data-fancybox="forum_image" class="link_" >
            <svg preserveAspectRatio="none" class="svg-solid" id="stage_1" width="451.17" height="324.216"
                ...
                <path data-name="Path 11"
                    ...
                    transform="translate(-213.484 -154.732)" fill="#000" opacity=".16" />
            </svg>
            ...
            <div class="img-wrapper">
                <div class="img_" style="background-image: url({{ $ytImage }});"></div>
            </div>
...
<a href="#" class="inn__">
    ...
    <svg preserveAspectRatio="none" class="svg-border" id="Layer_1" x="0px" y="0px" viewBox="245 -151.5 463 351"
    ...
    <div class="slide-box">
        <div class="swiper article-slide">
            <div class="swiper-wrapper">

                @if ($articleDetails->getData('esafe_kid_heading1'))
                    <div class="article-slides swiper-slide" style="position: relative;">
                        <div class="img-wrapper">
                            <div class="img_"
                                style="background-image: url({{ PP($articleDetails->getData('esafe_kid_image1')) }});">
                            </div>
                        </div>
                        <h2>{{ $articleDetails->getData('esafe_kid_heading1') }}</h2>
                        <div class="text_">
                            <p>{{ $articleDetails->getData('esafe_kid_description1') }}</p>
                        </div>
                    </div>
                @endif

                @if ($articleDetails->getData('esafe_kid_heading2'))
                    <div class="article-slides swiper-slide" style="position: relative;">
                        <div class="img-wrapper">
                            <div class="img_"
                                style="background-image: url({{ PP($articleDetails->getData('esafe_kid_image2')) }});">
                            </div>
                        </div>
                        <h2>{{ $articleDetails->getData('esafe_kid_heading2') }}</h2>
                        <div class="text_">
                            <p>{{ $articleDetails->getData('esafe_kid_description2') }}</p>
                        </div>
                    </div>
                @endif

                @if ($articleDetails->getData('esafe_kid_heading3'))
                    <div class="article-slides swiper-slide" style="position: relative;">
                        <div class="img-wrapper">
                            <div class="img_"
                                style="background-image: url({{ PP($articleDetails->getData('esafe_kid_image3')) }});">
                            </div>
                        </div>
                        <h2>{{ $articleDetails->getData('esafe_kid_heading3') }}</h2>
                        <div class="text_">
                            <p>{{ $articleDetails->getData('esafe_kid_description3') }}</p>
                        </div>
                    </div>
                @endif
