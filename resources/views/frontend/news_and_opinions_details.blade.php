  ...
  <section class="page-section">
    ...
    <div class="breadCrumbWrap ">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ asset($lang.'/news_and_opinions') }}" class="homebrc">{{ lang('news_and_opinions') }}</a></li>            
            <li class="current">{!!  $news_and_opinions_details->getData('post_title') !!}</li>
        </ol>
    </div>

      <div class="normal_details_wrapper">
		<!-- <a href="{{ asset($lang.'/news_and_opinions') }}">{{ lang('back_to_news') }}</a> -->
	  </div>
      <div class="normal_details_wrapper">
        <div class="side_box">
          ...
          <div class="inner_box">
            <div class="link_">
              ...
              <div class="img_box">
                <div class="img_ b-lazy" data-src="{{ PP($news_and_opinions_details->getData('news_banner')) }}"></div>
                <div class="meta_tag color-lightblue">
                    <ul>
                    @foreach($news_and_opinions_details->tags as $tag) 
        ...
        <div class="content_box">
          ...
          <div class="head_box">
            <div class="title_">{!!  $news_and_opinions_details->getData('post_title') !!}</div>
          </div>
          <div class="text_box">
           {!! $news_and_opinions_details->getData('description')  !!}
          </div>
