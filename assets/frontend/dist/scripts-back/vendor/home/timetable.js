        ...
        Timetable.prototype = {
            ...
            draw: function (e) {
                ...
                function o(e) {
                    for (var t = 0; t < m.locations.length; t++) {
                        var n = e.appendChild(document.createElement("li")),
                            ...
                            p = n.appendChild(document.createElement("span"));
                        o.className = "row-heading", o.textContent = m.locations[t].title;
                        p.className = "row-subheading", p.textContent = m.locations[t].subtitle
                    }
                }
                ...
                function u(e, t) {
                    ...
                    }), s.className = o ? "time-entry " + e.options["class"] : "time-entry", s.style.width = f(e), s.style.left = p(e), l.textContent = e.name
                }
